...
import 'package:payment_app/Screen/usdtDepositeHisDetails.page.dart';
...
import 'package:payment_app/data/controller/usdtDepositeHistoryController.dart';

class InrToTokenBuyHistoryPage extends ConsumerStatefulWidget {
  const InrToTokenBuyHistoryPage({super.key});

  @override
  ConsumerState<InrToTokenBuyHistoryPage> createState() =>
      _InrToTokenBuyHistoryPageState();
}

class _InrToTokenBuyHistoryPageState
    extends ConsumerState<InrToTokenBuyHistoryPage> {
  String selectedWallet = "USDT";

  @override
  Widget build(BuildContext context) {
    final inrToTokenState = ref.watch(InrToTokenBuyHistoryController);
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            onPressed: () {
              ref.invalidate(InrToTokenBuyHistoryController);
            },
            icon: const Icon(Icons.refresh, color: Colors.white70),
          ),
        ],
      ),
      body: inrToTokenState.when(
        data: (data) {
