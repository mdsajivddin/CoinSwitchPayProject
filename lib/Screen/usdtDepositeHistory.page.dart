...
class USDTDepositeHistoryPage extends ConsumerStatefulWidget {
  const USDTDepositeHistoryPage({super.key});

  @override
  ConsumerState<USDTDepositeHistoryPage> createState() =>
      _TransactionPageState();
}

class _TransactionPageState extends ConsumerState<USDTDepositeHistoryPage> {
  String selectedWallet = "USDT";

  @override
  Widget build(BuildContext context) {
    final state = ref.watch(usdtDepositHistoryProvider);
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            onPressed: () {
              ref
                  .read(usdtDepositHistoryProvider.notifier)
                  .getUsdtDepositHistory();
            },
                ...
                return InkWell(
                  onTap: () {
                    Navigator.push(
                      context,
                      RightSlideFadeRoute(
                        page: UsdtDepositeHisDetailsPage(item: list[index]),
                      ),
                    );
                  },
