...
//                                 amount:
//                                     "${totalToken.toStringAsFixed(2)} TOKEN",
                        ...
                        data: (data) {
                          ...
                          return Column(
                            ...
                            children: [
                              ...
                              balanceCard(
                                title: "Available USDT Balance",
                                amount: "${totalUsdt.toSmartString()} USDT",
                                icon: Icons.account_balance_wallet,
                                isFullWidth: true,
                              ),
                              SizedBox(height: 15.h),
                              balanceCard(
                                title: "Available TOKEN Balance",
                                amount: "${totalToken.toSmartString()} TOKEN",
                                icon: Icons.account_balance_wallet,
                                isFullWidth: true,
                              ),
                              ...
                              commissionState.when(
                                data: (commissionData) {
                                  // Data type check karke parsing ko handle kiya hai safe side ke liye
                                  final todayUsdtAmount =
                                      double.tryParse(
                                        commissionData?.data?.usdtAmount
                                                ?.toString() ??
                                            '0',
                                      ) ??
                                      0.0;
                                  final todayTokenAmount =
                                      double.tryParse(
                                        commissionData?.data?.tokenAmount
                                                ?.toString() ??
                                            '0',
                                      ) ??
                                      0.0;
                                  ...
                                  return Column(
                                    children: [
                                      teamCard(
                                        ...
                                        leftTitle: "Today Team Commission",
                                        leftAmount:
                                            todayUsdtAmount.toSmartString(),
                                        rightTitle: "Total Team Commission",
                                        rightAmount:
                                            totalUsdtCommission.toSmartString(),
                                      ),
                                      SizedBox(height: 25.h),
                                      teamCard(
                                        title: "TEAM EARNINGs TOKEN",
                                        leftTitle: "Today Team Commission",
                                        leftAmount:
                                            todayTokenAmount.toSmartString(),
                                        rightTitle: "Total Team Commission",
                                        rightAmount:
                              ...
                              activeSellingCard(
                                "Active Selling",
                                tokenSelling.toSmartString(),
                                usdtSelling.toSmartString(),
                              ),
                              SizedBox(height: 30.h),
                            ],
                          );
