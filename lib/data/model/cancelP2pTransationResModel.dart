...
//
//     final cancelP2PTransationResModel = cancelP2PTransationResModelFromJson(jsonString);

import 'dart:convert';

CancelP2PTransationResModel cancelP2PTransationResModelFromJson(String str) => CancelP2PTransationResModel.fromJson(json.decode(str));

String cancelP2PTransationResModelToJson(CancelP2PTransationResModel data) => json.encode(data.toJson());

class CancelP2PTransationResModel {
    String? message;
    int? code;
    bool? error;
    Data? data;

    CancelP2PTransationResModel({
        this.message,
        this.code,
        this.error,
        this.data,
    ...
    factory CancelP2PTransationResModel.fromJson(Map<String, dynamic> json) => CancelP2PTransationResModel(
