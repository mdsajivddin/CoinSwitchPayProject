...
GetSellByIdDetailsModel getSellByIdDetailsModelFromJson(String str) => GetSellByIdDetailsModel.fromJson(json.decode(str));

String getSellByIdDetailsModelToJson(GetSellByIdDetailsModel data) => json.encode(data.toJson());
...
class GetSellByIdDetailsModel {
    ...
    factory GetSellByIdDetailsModel.fromJson(Map<String, dynamic> json) => GetSellByIdDetailsModel(
