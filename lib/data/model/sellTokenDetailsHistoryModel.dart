...
SellTokenDetailsHistoryModel sellTokenDetailsHistoryModelFromJson(String str) =>
    SellTokenDetailsHistoryModel.fromJson(json.decode(str));

String sellTokenDetailsHistoryModelToJson(SellTokenDetailsHistoryModel data) =>
...
class SellTokenDetailsHistoryModel {
  ...
  factory SellTokenDetailsHistoryModel.fromJson(Map<String, dynamic> json) =>
      SellTokenDetailsHistoryModel(
