...
UsdtToInrSellHistoryModel usdtToInrSellHistoryModelFromJson(String str) => UsdtToInrSellHistoryModel.fromJson(json.decode(str));

String usdtToInrSellHistoryModelToJson(UsdtToInrSellHistoryModel data) => json.encode(data.toJson());
...
class UsdtToInrSellHistoryModel {
    ...
    factory UsdtToInrSellHistoryModel.fromJson(Map<String, dynamic> json) => UsdtToInrSellHistoryModel(
